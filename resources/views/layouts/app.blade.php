...
.body{
    background: url('..e/images/css/111.jpg');
}
</style>
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <!-- carts -->
                            <li class="nav-item">
                                ...
                                @if (session('cart'))
                                    <i class="  fa fa-cart-plus" aria-hidden="true"></i> <button>Cart</button> <span class="badge badge-pill badge-danger">{{ count(session('cart')) }}</span>
                                @else
